...
periodOfWorkInMonths: yup
	...
	.min(0, 'Period of work must be greater than or equal to 0')
	.nullable(),
workOrderAmount: yup
	.number()
	.typeError('Work order amount must be a number')
	.min(0, 'Work order amount must be greater than or equal to 0')
	.nullable()
});
