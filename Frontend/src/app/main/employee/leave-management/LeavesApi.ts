...
const injectedRtkApi = api.injectEndpoints({
	endpoints: (build) => ({
		...
		getApiLeavesHolidays: build.query<GetApiLeavesHolidaysApiResponse, GetApiLeavesHolidaysApiArg>({
			query: () => ({ url: `/api/Leaves/holidays` })
		}),
		postApiLeavesHolidays: build.mutation<PostApiLeavesHolidaysApiResponse, PostApiLeavesHolidaysApiArg>({
			query: (queryArg) => ({
		...
		getApiLeavesLeavesAll: build.query<GetApiLeavesLeavesAllApiResponse, GetApiLeavesLeavesAllApiArg>({
		...
		getApiLeavesDefaultLeaves: build.query<GetApiLeavesDefaultLeavesApiResponse, GetApiLeavesDefaultLeavesApiArg>({
...
export type GetApiLeavesHolidaysApiResponse = /** status 200 OK */ EmployeeHoliday[];
...
export type GetApiLeavesLeavesAllApiResponse = /** status 200 OK */ EmployeeLeaveModel[];
export type GetApiLeavesLeavesAllApiArg = void;
export type PostApiLeavesLeavesEmployeeLeaveHistoryApiResponse = /** status 200 OK */ EmployeeLeaveHistoryDto[];
export type PostApiLeavesLeavesEmployeeLeaveHistoryApiArg = {
	employeeLeaveHistoryDataModel: EmployeeLeaveHistoryDataModel;
};
export type GetApiLeavesDefaultLeavesApiResponse = /** status 200 OK */ EmployeeDefaultLeaveSummary[];
...
export type GetApiLeavesHolidaysByYearApiResponse = /** status 200 OK */ EmployeeHoliday[];
