...
function BasicInfoTab() {
  const { data: employeesCategoriesOptions = [] } =
    useGetApiEmployeesCategoriesQuery();
              ...
              render={({ field: { onChange, value } }) => (
                ...
                >
                  ...
                  <input
                    ...
                    hidden
                    onChange={(e) =>
                      handlePhotoUpload(e.target.files?.[0] || null, onChange)
                    }
                    accept="image/*"
                  />
                </Box>
                  ...
                  <EnhancedAutocomplete
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        helperText={
                          errors?.employeeCategoryId?.message as string
                        }
                      />
                    )}
              ...
              <Controller
                ...
                render={({ field: { onChange, value } }) => (
                  <Autocomplete
                    ...
                    value={
                      employeesRolesOptions.find((c) => c.id === value) || null
                    }
                    onChange={(_, newValue) => {
