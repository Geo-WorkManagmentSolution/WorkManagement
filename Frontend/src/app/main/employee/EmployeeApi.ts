...
const injectedRtkApi = api.injectEndpoints({
	endpoints: (build) => ({
		...
		getApiEmployeesCategories: build.query<GetApiEmployeesCategoriesApiResponse, GetApiEmployeesCategoriesApiArg>({
		...
		getApiEmployeesSites: build.query<GetApiEmployeesSitesApiResponse, GetApiEmployeesSitesApiArg>({
...
export type GetApiEmployeesApiResponse = /** status 200 OK */ EmployeeDashboardDataModel[];
...
export type GetApiEmployeesCategoriesApiResponse = /** status 200 OK */ EmployeeCategory[];
export type GetApiEmployeesCategoriesApiArg = void;
export type GetApiEmployeesDepartmentsApiResponse = /** status 200 OK */ EmployeeDepartment[];
export type GetApiEmployeesDepartmentsApiArg = void;
export type GetApiEmployeesDesignationsApiResponse = /** status 200 OK */ EmployeeDesignation[];
...
export type GetApiEmployeesReportToEmployeeListApiResponse = /** status 200 OK */ EmployeeReportToModel[];
export type GetApiEmployeesReportToEmployeeListApiArg = {
	departmentId?: number;
	employeeId?: number;
};
export type GetApiEmployeesTeamMembersListApiResponse = /** status 200 OK */ EmployeeTeamMemberList[];
...
export type GetApiEmployeesCheckEmailExistsApiResponse = /** status 200 OK */ boolean;
...
export type GetApiEmployeesLeavesCurrentApiResponse = /** status 200 OK */ EmployeeLeaveSummaryModel[];
export type GetApiEmployeesLeavesCurrentApiArg = {
	employeeId?: number;
};
export type PostApiEmployeesLeavesAddLeaveApiResponse = /** status 200 OK */ EmployeeLeaveModel;
export type PostApiEmployeesLeavesAddLeaveApiArg = {
	employeeLeaveModel: EmployeeLeaveModel;
};
export type PutApiEmployeesLeavesUpdateLeaveApiResponse = /** status 200 OK */ EmployeeLeaveModel;
export type PutApiEmployeesLeavesUpdateLeaveApiArg = {
	employeeLeaveModel: EmployeeLeaveModel;
};
export type DeleteApiEmployeesLeavesCancelLeaveApiResponse = /** status 200 OK */ boolean;
export type DeleteApiEmployeesLeavesCancelLeaveApiArg = {
	employeeLeaveId?: number;
};
export type PutApiEmployeesApproveByLeaveIdApiResponse = /** status 200 OK */ EmployeeLeave;
export type PutApiEmployeesApproveByLeaveIdApiArg = {
	leaveId: number;
};
export type PutApiEmployeesRejectByLeaveIdApiResponse = /** status 200 OK */ EmployeeLeave;
export type PutApiEmployeesRejectByLeaveIdApiArg = {
	leaveId: number;
};
export type PostApiEmployeesDocumnetUploadApiResponse = /** status 200 OK */ string;
